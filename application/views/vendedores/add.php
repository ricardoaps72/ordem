                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form class="user" method="post" name="form_edit">
                            ...
                            <div class="form-group row">
                              <div class="col-md-4">
                                  <label>CNPJ</label>
                                  <input type="text" class="form-control form-control-user" name="fornecedor_cnpj" placeholder="CNPJ" value="<?php echo set_value('fornecedor_cnpj'); ?>">
                              ...
                              <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control form-control-user" name="fornecedor_telefone" placeholder="Telefone fixo" value="<?php echo set_value('fornecedor_telefone'); ?>">
                            ...
                            <div class="form-group row">
                              <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control form-control-user" name="fornecedor_celular" placeholder="Telefone Celular" value="<?php echo set_value('fornecedor_celular'); ?>">
                                  <?php echo form_error('fornecedor_celular', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>                                  
                              <div class="col-md-4">
                                  <label>E-mail</label>
                                  <input type="text" class="form-control form-control-user" name="fornecedor_email" placeholder="E-mail" value="<?php echo set_value('fornecedor_email'); ?>">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="text" class="form-control form-control-user" name="fornecedor_endereco" placeholder="Seu endereço" value="<?php echo set_value('fornecedor_endereco'); ?>">
                              ...
                              <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control form-control-user" name="fornecedor_complemento" placeholder="Complemento de endereço" value="<?php echo set_value('fornecedor_complemento'); ?>">
                          ...
                          <div class="form-group row">
                              <div class="col-md-5">
                                  <label>Bairro</label>
                                  <input type="text" class="form-control form-control-user " name="fornecedor_bairro" placeholder="Seu Bairro" value="<?php echo set_value('fornecedor_bairro'); ?>">
                                    <?php echo form_error('fornecedor_bairro', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>    

                            <div class="col-md-2">
                                <label>Cep</label>
                                <input type="text" class="form-control form-control-user cep" name="fornecedor_cep" placeholder="Seu Cep" value="<?php echo set_value('fornecedor_cep'); ?>">
                            ...
                            <div class="col-md-1">
                                <label>UF</label>
                                <input type="text" class="form-control form-control-user" name="fornecedor_estado" placeholder="Estado" value="<?php echo set_value('fornecedor_estado'); ?>">
