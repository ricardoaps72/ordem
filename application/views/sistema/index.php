                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-3">
                                  <label>E-mail</label>
                                  <input type="text" class="form-control form-control-user" name="sistema_email" placeholder="E-mal" value="<?php echo $sistema->sistema_email ?>">
                          ...
                          <div class="form-group row">
                              <div class="col-md-12">
                                  ...
                                  <textarea class="form-control form-control-user" name="sistema_txt_ordem_servico" placeholder="Texto da ordem de serviço"><?php echo $sistema->sistema_txt_ordem_servico ?></textarea>
