    ...
    <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title = "Cadastrar novo usuário" href="<?php echo base_url('usuarios/add'); ?>" class="btn btn-success btn-sm float-right">
                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($this->ion_auth->is_admin($user->id) ? 'Administrator' : 'Vendedor'); ?></td>
                                            <td class="text-center pr-4"><?php echo ($user->active == 1 ? '<span class="badge bg-info btn-sm">Sim</span>' : '<span class="badge bg-warning text-dark btn-sm">Não</span>') ?></td>
                                            <td class="text-right">
                                                ...
                                                <a title ="Excluir" href="javascript(void)" data-toggle="modal" 
                                                   data-target="#user-<?php echo $user->id; ?>" class = "btn btn-sm btn-danger">
