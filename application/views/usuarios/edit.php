                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                              <div class="col-md-4">
                                  ...
                                  <?php echo form_error('first_name', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>                                  
                              <div class="col-md-4">
                                  <label>Sobrenome</label>
                                  <input type="text" class="form-control" name="last_name" placeholder="Seu Sobrenome" value="<?php echo $usuario->last_name ?>">
                                    <?php echo form_error('last_name', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>                                  
                              <div class="col-md-4">
                                  <label>E-mail&nbsp;(Login)</label>
                                  <input type="email" class="form-control" name="email" placeholder="Seu email" value="<?php echo $usuario->email ?>">
                                    <?php echo form_error('email', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>                                  
                          </div>
                          ...
                          <div class="form-group row">
                              <div class="col-md-4">
                                  ...
                                  <input type="text" class="form-control" name="username" placeholder="Seu usuário" value="<?php echo $usuario->username ?>">
                                    <?php echo form_error('username', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>                                  
                          ...
                          <div class="form-group row">
                              <div class="col-md-4">
                                  ...
                                  <input type="password" class="form-control" name="password" placeholder="Sua senha" >
                                    <?php echo form_error('password', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>                                  

                              <div class="col-md-6">
                                  <label>Confirmar Senha</label>
                                  <input type="password" class="form-control" name="confirm_password" placeholder="Confirme sua senha" >
                                    <?php echo form_error('confirm_password', '<small id="emailHelp" class="form-text text-muted">', '</small>') ?>  
                              </div>                                  
