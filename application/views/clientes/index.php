                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center pr-4"><?php echo ($cliente->cliente_ativo == 1 ? '<span class="badge bg-info btn-sm">Sim</span>' : '<span class="badge bg-warning text-dark btn-sm">Não</span>') ?></td>
                                            <td class="text-right">
                                                <a title ="Editar" href="<?php echo base_url('clientes/edit/'.$cliente->cliente_id); ?>" class = "btn btn-sm btn-primary">
                                                    <i class="fas fa-user-edit"></i>
                                                </a>
                                                <a title ="Excluir" href="javascript(void)" data-toggle="modal" 
                                                   data-target="#cliente-<?php echo $cliente->cliente_id; ?>" class = "btn btn-sm btn-danger">
